...
On Debian-based systems, the signed APT repository at `https://zester.cc/repo`
...
sudo curl -fsSL https://zester.cc/repo/zester.gpg \
  -o /usr/share/keyrings/zester.gpg

# 2. Add the repository
echo "deb [signed-by=/usr/share/keyrings/zester.gpg] https://zester.cc/repo stable main" \
