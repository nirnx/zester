---
title: "pip"
description: "The pip.* family of state modules."
---
...
| Module | Summary |
|---|---|
| [`pip.installed`](#pip-installed) | Ensure a Python package is installed via pip, optionally pinned or from a requirements file. |
