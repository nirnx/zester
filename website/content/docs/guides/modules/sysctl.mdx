---
title: "sysctl"
description: "The sysctl.* family of state modules."
---
...
| Module | Summary |
|---|---|
| [`sysctl.present`](#sysctl-present) | Ensure a kernel parameter is set to a value at runtime and, by default, persisted. |
