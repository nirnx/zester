...
- [test.false](/docs/guides/execution-modules#test-false)
...
- [test.true](/docs/guides/execution-modules#test-true)
...
- [grains.items](/docs/guides/execution-modules#grains-items)
...
- [grains.item](/docs/guides/execution-modules#grains-item)
...
| Parameter | Type | Required | Default | Description |
|---|---|---|---|---|
| `name` | `string` | No | Request ID (bare positional) | module name — or bare family name, rendering every member — to document; when omitted, the unified index of every callable surface is returned |
...
- [sys.list_functions](/docs/guides/execution-modules#sys-list-functions)
...
- [sys.doc](/docs/guides/execution-modules#sys-doc)
