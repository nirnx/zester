...
Because these grants are hand-enumerated and easy to miss, `zester auth lint` decodes a `.creds` file and flags the gaps offline:

```bash
$ zester auth lint /var/lib/zester/auth/web-01.creds
