...
func TestSvcRunning_Name(t *testing.T) {
	...
	s, err := servicemod.NewSvcRunningBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcRunning_PrimaryParamDefault(t *testing.T) {
	fake := exectest.NewFakeServiceExec("systemd")
	mctx := testSvcMctx(fake)
	s, err := servicemod.NewSvcRunningBuilder(mctx, modschema.DecodeOptions{})("myservice", map[string]any{})
	if err != nil {
		t.Fatal(err)
	}
	sr := s.(*servicemod.SvcRunning)
...
func TestSvcRunning_CheckNeedsChange(t *testing.T) {
	...
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcRunningBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
...
func TestSvcRunning_ApplyEnable(t *testing.T) {
	...
	fake.PreAdd("nginx", false, false)
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcRunningBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{"enable": true})
...
func TestSvcRunning_CheckEnableFalseDrift(t *testing.T) {
	...
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcRunningBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{"enable": false})
	result, err := s.Check(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcRunning_NilProvider(t *testing.T) {
	...
	_, err := servicemod.NewSvcRunningBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	if err == nil {
...
func TestSvcEnabled_Name(t *testing.T) {
	fake := exectest.NewFakeServiceExec("systemd")
	mctx := testSvcMctx(fake)
	s, err := servicemod.NewSvcEnabledBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcEnabled_PrimaryParamDefault(t *testing.T) {
	fake := exectest.NewFakeServiceExec("systemd")
	mctx := testSvcMctx(fake)
	s, err := servicemod.NewSvcEnabledBuilder(mctx, modschema.DecodeOptions{})("sshd", map[string]any{})
	if err != nil {
		t.Fatal(err)
	}
	se := s.(*servicemod.SvcEnabled)
	if se.Service != "sshd" {
...
func TestSvcEnabled_CheckNeedsChange(t *testing.T) {
	...
	fake.PreAdd("nginx", false, false)
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcEnabledBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	result, err := s.Check(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcEnabled_RevertFreshInstanceNoOp(t *testing.T) {
	...
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcEnabledBuilder(mctx, modschema.DecodeOptions{})("sshd", map[string]any{})
	result, err := s.Revert(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcEnabled_NilProvider(t *testing.T) {
	mctx := &exec.ModuleContext{ProviderSet: exec.ProviderSet{Service: nil}}
	_, err := servicemod.NewSvcEnabledBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	if err == nil {
		t.Error("expected error when Service provider is nil")
	}
}
...
func TestSvcDead_Name(t *testing.T) {
	fake := exectest.NewFakeServiceExec("systemd")
	mctx := testSvcMctx(fake)
	s, err := servicemod.NewSvcDeadBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcDead_PrimaryParamDefault(t *testing.T) {
	fake := exectest.NewFakeServiceExec("systemd")
	mctx := testSvcMctx(fake)
	s, err := servicemod.NewSvcDeadBuilder(mctx, modschema.DecodeOptions{})("mysql", map[string]any{})
	if err != nil {
		t.Fatal(err)
	}
	sd := s.(*servicemod.SvcDead)
	if sd.Service != "mysql" {
...
func TestSvcDead_CheckNeedsChange(t *testing.T) {
	...
	fake.PreAdd("nginx", true, true)
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcDeadBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	result, err := s.Check(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcDead_ApplyDisable(t *testing.T) {
	...
	fake.PreAdd("nginx", true, true)
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcDeadBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{"enable": false})
	_, err := s.Apply(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcDead_RevertFreshInstanceNoOp(t *testing.T) {
	...
	mctx := testSvcMctx(fake)
	s, _ := servicemod.NewSvcDeadBuilder(mctx, modschema.DecodeOptions{})("telemetry-agent", map[string]any{})
	result, err := s.Revert(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestSvcDead_NilProvider(t *testing.T) {
	mctx := &exec.ModuleContext{ProviderSet: exec.ProviderSet{Service: nil}}
	_, err := servicemod.NewSvcDeadBuilder(mctx, modschema.DecodeOptions{})("nginx", map[string]any{})
	if err == nil {
		t.Error("expected error when Service provider is nil")
	}
}
