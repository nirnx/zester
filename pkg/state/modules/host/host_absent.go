...
var hostAbsentSpec = regdef.MustSpec("host.absent", modschema.KindState, HostAbsent{}, modschema.Doc{
...
func (h *HostAbsent) Revert(ctx context.Context) (state.ApplyResult, error) {
	return famshared.RevertHostsFile(ctx, h.file, h.Path, h.backup, h.backupSet, false, 0644, "host.absent")
}
