...
var (
	fileCommentSpec = regdef.MustSpec("file.comment", modschema.KindState, FileComment{}, modschema.Doc{
	...
	fileUncommentSpec = regdef.MustSpec("file.uncomment", modschema.KindState, FileComment{}, modschema.Doc{
