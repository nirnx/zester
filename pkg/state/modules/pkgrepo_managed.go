...
var pkgrepoManagedSpec = mustSpec("pkgrepo.managed", modschema.KindState, PkgrepoManaged{}, modschema.Doc{
...
func NewPkgrepoManagedBuilder(mctx *exec.ModuleContext, opts modschema.DecodeOptions) state.Builder {
	return func(id string, config map[string]any) (state.State, error) {
		...
		r.family, r.mgr = detectPkgSystem(mctx.Facts, providerName)
