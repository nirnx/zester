...
var pkgPurgedSpec = regdef.MustSpec("pkg.purged", modschema.KindState, PkgPurged{}, modschema.Doc{
...
func NewPkgPurgedBuilder(mctx *exec.ModuleContext, opts modschema.DecodeOptions) state.Builder {
	return func(id string, config map[string]any) (state.State, error) {
		...
		p.family, p.mgr = famshared.DetectPkgSystem(mctx.Facts, providerName)
