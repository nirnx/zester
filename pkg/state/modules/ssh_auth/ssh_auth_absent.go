...
var sshAuthAbsentSpec = regdef.MustSpec("ssh_auth.absent", modschema.KindState, SSHAuthAbsent{}, modschema.Doc{
...
func (s *SSHAuthAbsent) Revert(ctx context.Context) (state.ApplyResult, error) {
	...
	return famshared.RevertHostsFile(ctx, s.file, path, s.backup, s.backupSet, false, 0600, "ssh_auth.absent")
}
